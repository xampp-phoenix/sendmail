...
function ReadTargetInfo(IDEVersion) {
	...
	RootDir = RegRead('HKLM', 'Software\\madshi\\madCollection\\', '');
	info.madCollection = RootDir + '\\madBasic\\BDS' + IDEVersion + '\\' + target;
	info.madCollection += ';' + RootDir + '\\madExcept\\BDS' + IDEVersion + '\\' + target;
	info.madCollection += ';' + RootDir + '\\madDisAsm\\BDS' + IDEVersion + '\\' + target;
	return info;
}
...
stream.WriteText('-I"' + info.madCollection + '"\n');
stream.WriteText('-U"' + info.madCollection + '"\n');
